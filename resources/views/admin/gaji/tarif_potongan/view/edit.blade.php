        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Tarif Potongan</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_potongan_id"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_nama_potongan"
                                       class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_tarif_per_kejadian"
                                       class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
