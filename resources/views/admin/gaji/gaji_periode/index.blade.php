...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Gaji Periode</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Gaji Periode</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6"
                               ...
                               title="Tambah Gaji Periode">Tambah Gaji Periode</a>
                        </div>
                    </div>
                </div>
                <div class="card-body p-5">
                    <div class="notice d-flex border-primary mb-4 rounded border border-dashed p-4 shadow bg-hover-light-dark">
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6">
                            <div class="row">
                                <span class="text-gray-700">Berikut ini adalah data gaji periode.</span>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive mb-8 shadow p-4 mx-0 border-hover-dark border-primary border-1 border-dashed fs-sm-8 fs-lg-6 rounded-2">
                        <table id="example"
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                ...
                                <th class="min-w-150px">ID Periode</th>
                                <th class="min-w-120px">Tahun</th>
                                <th class="min-w-120px">Tanggal Mulai</th>
                                <th class="min-w-120px">Tanggal Selesai</th>
    ...
    @include('admin.gaji.gaji_periode.view.detail')
    @include('admin.gaji.gaji_periode.view.create')
    @include('admin.gaji.gaji_periode.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.gaji.gaji_periode.script.list')
    @include('admin.gaji.gaji_periode.script.create')
    @include('admin.gaji.gaji_periode.script.edit')
    @include('admin.gaji.gaji_periode.script.detail')
@endsection