...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Dokumen</li>
@endsection
                ...
                <div class="card-toolbar mb-4">
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                data-bs-target="#form_create" title="Tambah Dokumen">
                            Tambah Dokumen
                        </button>
                    </div>
                </div>
...
@section('javascript')
    ...
    @include('admin.sdm.dokumen.script.list')
    @include('admin.sdm.dokumen.script.create')
    @include('admin.sdm.dokumen.script.edit')
    @include('admin.sdm.dokumen.script.detail')
    @include('admin.sdm.dokumen.script.delete')
@endsection