...
@section('content')
    ...
    @include('admin.absensi.pengajuan_izin.view.detail')
    @include('admin.absensi.pengajuan_izin.view.create')
    @include('admin.absensi.pengajuan_izin.view.edit')
    @include('admin.absensi.pengajuan_izin.view.approval')
@endsection
...
@section('javascript')
    ...
    @include('admin.absensi.pengajuan_izin.script.list')
    @include('admin.absensi.pengajuan_izin.script.create')
    @include('admin.absensi.pengajuan_izin.script.edit')
    @include('admin.absensi.pengajuan_izin.script.detail')
    @include('admin.absensi.pengajuan_izin.script.approval')
@endsection