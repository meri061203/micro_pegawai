        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Libur Perusahaan</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1 required">
                                    <span>ID Libur Perusahaan</span>
                                </label>
                                <input type="text" id="edit_libur_perusahaan_id"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_nama_libur_perusahaan"
                                       class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
