...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Jenis Absensi</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Jenis Absensi</span>
                    </h3>
    ...
    @include('admin.absensi.jenis_absensi.view.detail')
    @include('admin.absensi.jenis_absensi.view.create')
    @include('admin.absensi.jenis_absensi.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.absensi.jenis_absensi.script.list')
